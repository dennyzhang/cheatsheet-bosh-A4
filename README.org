...
| Stemcells                     | A generic VM image that BOSH clones and configures during deployment. [[https://bosh.cloudfoundry.org/stemcells/][link: stemcell]]      |
...
| Manifest                      | A YAML file that identifies one or more releases, stemcells and configurations            |
...
| Link                          | https://bosh.io/docs/terminology                                                          |
** Bosh Basic
| Name                      | Command                                                                             |
|---------------------------+-------------------------------------------------------------------------------------|
...
| Get task detail msg           | =bosh task $id --debug=                        |
...
| monit: List bosh deployed daemon processes | =monit summary=                             |
| monit: Restart a given daemon processes    | =monit restart <process_name>=              |
** Ops manager
| Name                                   | Command                                                                  |
|----------------------------------------+--------------------------------------------------------------------------|
| Release folder                         | =/var/tempest/releases=                                                  |
