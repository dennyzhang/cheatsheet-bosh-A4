...
| Run errand in vms not deleted | =bosh -n -d <deployment> run-errand <errand_name> --keep-alive= |
** Bosh Concepts
| Name               | Comment                                                                                                               |
|--------------------+-----------------------------------------------------------------------------------------------------------------------|
| Reference          | [[https://bosh.io/docs/terminology][link: terminology]]                                                                                                     |
...
| Interpolates variables    | =bosh int /tmp/build/4dcXX/pks-lock/metadata --path=/ops_manager/username= [[https://bosh.io/docs/cli-int/][link]] |
...
| Prepare the credential | To get files from S3/GCP buckets, make sure =config/private.yml= has been configured correctly |
...
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO Get the errand output                                       :noexport:
