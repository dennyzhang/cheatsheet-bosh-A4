...
Related post: [[https://cheatsheet.dennyzhang.com/cheatsheet-concourse-A4][Concourse CheatSheet]], [[https://cheatsheet.dennyzhang.com/cheatsheet-pks-A4][PKS CheatSheet]]
...
| [[https://docs.pivotal.io/tiledev/2-2/tile-structure.html][Bosh Tile]]                       | A *.pivotal file containing everything needed to install/upgrade a PCF service            |
...
| Bosh Operations file (ops file) | A YAML file that includes multiple operations to be applied to a different YAML file.     |
...
| Delete a vm                | =bosh -d <deployment> delete-vm <vm>=    |
| SSH to vm                  | =bosh -e <env> -d <deployment> ssh <vm>= |
** Bosh Deployment
| Name                          | Command                                             |
|-------------------------------+-----------------------------------------------------|
